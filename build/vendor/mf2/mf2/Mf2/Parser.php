...
namespace Webmention_Comments\Mf2;
...
{
    $parser = new \Webmention_Comments\Mf2\Parser($input, $url);
...
class Parser
{
    ...
    public function __construct($input, $url = null, $jsonMode = \false)
    {
        ...
        if (\is_string($input)) {
            if (\class_exists('Webmention_Comments\\Masterminds\\HTML5')) {
                $doc = new \Webmention_Comments\Masterminds\HTML5(array('disable_html_ns' => \true));
