...
use Webmention_Comments\Masterminds\HTML5\Exception;
/**
...
class Scanner
{
    ...
    {
        if ($data instanceof \Webmention_Comments\Masterminds\HTML5\Parser\InputStream) {
        ...
        $data = \Webmention_Comments\Masterminds\HTML5\Parser\UTF8Utils::convertToUTF8($data, $encoding);
        // There is good reason to question whether it makes sense to
        // do this here, since most of these checks are done during
        // parsing, and since this check doesn't actually *do* anything.
        $this->errors = \Webmention_Comments\Masterminds\HTML5\Parser\UTF8Utils::checkForIllegalCodepoints($data);
    ...
    public function columnOffset()
    {
        ...
        return \Webmention_Comments\Masterminds\HTML5\Parser\UTF8Utils::countChars($findLengthOf);
    }
    /**
